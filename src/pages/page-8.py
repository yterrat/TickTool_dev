...
layout = html.Div([
    ...
    html.Div([
        ...
        html.P('We would be grateful if you could complete the following socio-demographic questions.'),
        html.P('This information helps us direct Lyme disease educational material to where it is most useful.')],
    ...
    ######
    html.Br(),
        html.P("Which of the following categories best describes your current employment status? Are you:", className='question_style2'),
    html.Br(),
    dcc.RadioItems(
            options=[
